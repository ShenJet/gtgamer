        ...
        if (info) {
            ...
            if (list && list.length > 0) {
                historyList = (<div>
                    ...
                    {isMore ? <div styleName="loanMore" onClick={() => this.loadMoreFn()}>点击加载更多</div> : <div styleName="loanMore"></div>}
                </div>)
            } else {
        ...
        return (
            <div styleName="wrap">
                ...
                <div styleName="header">
                    <img src={this.props.userInfos.AvatarUrl?this.props.userInfos.AvatarUrl:'img/avatar.png'} alt="" />
                </div>
