...
import checkversion from '../../reducers/checkversion'
...
class MatchComponent extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            showSteamAlert: this.props.userSteamAlert,//true=绑定steam账号弹窗
            showUrlAlert: this.props.userUrlAlert,//true=弹窗设置交易url
        }
    }
    ...
    componentDidMount() {
            ...
            var self = this
            if(this.state.showSteamAlert || this.state.showUrlAlert)
                return
            checkversion.judgeversion( ) 
