...
class TabBarExample extends React.Component {
    ...
    lotteryPart = () => {
        ...
        let whichTab = this.state.tabs['tab'+window.last_tab_type]
                        ...
                        onPress={() => {
                            if(this.props.showGame){
                                ...
                                setTimeout(() => {
                                    ...
                                    // window.cordova.InAppBrowser.open(this.props.userInfos.ChessUrl, '_blank', 'location=no')
